...
var() Localized String[200] DeathMessage;
...
// Deathmessages
function string[200] KillMessage( pawn Other )
{
	return ParseKillMessage(Other, DeathMessage);
}

// %k = Owner's PlayerName (Killer)
// %o = Other's PlayerName (Victim)
// %w = Owner's Weapon ItemName
intrinsic function string[200] ParseKillMessage( pawn Other, string[200] Message );
