...
var() localized string[32]  ItemName; // Human readable name of item
var() localized string[16]	ItemArticle; // Human readable article (e.g. "a", "an")
...
// Draw first person view of inventory (called by HUD for weapon)
