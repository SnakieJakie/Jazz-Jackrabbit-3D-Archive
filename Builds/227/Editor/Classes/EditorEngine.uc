...
defaultproperties
{
     ...
     EditPackages(5)="IpServer"
     EditPackages(6)="JazzFonts"
     EditPackages(7)="JazzObjectoids"
     EditPackages(8)="JazzDecoration"
     EditPackages(9)="JazzEnemy"
     EditPackages(10)="JazzMultiPlayer"
     EditPackages(11)="JazzContent"
     EditPackages(12)="Jazz3"
     EditPackages(13)="JazzRace"
     EditPackages(14)="JazzPlatform"
     EditPackages(15)="JazzArt"
     EditPackages(16)="CalyGame"
     EditPackages(17)="JazzConsole"
     EditPackages(18)="JWindow"
     EditPackages(19)="JazzObjectoids"
     C_WorldBox=(B=107)
     C_GroundPlane=(B=63)
